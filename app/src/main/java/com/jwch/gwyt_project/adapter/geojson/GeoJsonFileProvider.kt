...
class GeoJsonFileProvider(override val itemViewType: Int, override val layoutId: Int) :
    BaseNodeProvider() {
    ...
    override fun convert(helper: BaseViewHolder, data: BaseNode) {
        ...
        val displayName = "${model.name.substringBeforeLast(".").self()} (${model.featureCount})"
