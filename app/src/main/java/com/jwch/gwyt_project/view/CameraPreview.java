...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final float SCALE_16_9 = 1.777f;
    public static final float SCALE_4_3 = 1.333f;
    ...
    public CameraPreview(Context context, Camera mCamera, boolean is16_9) {
        super(context);
...
//        parameters.setRotation(getDisplayOrientation(mCameraId));
        ...
        if(is16_9){
            screenHeight = (int) ((screenWidth) * SCALE_16_9);
        }else {
            screenHeight = (int) ((screenWidth) * SCALE_4_3);
        }
...
//            parameters.setPictureSize(1920, 1080);
    ...
    public void setPreviewSize(int width, int height) {
        ...
        System.out.println("===log===" + width + " " + height);
        //获取系统支持预览大小
        ...
        if (localSizes != null) {
            ...
            for (Camera.Size size : localSizes) {
                ...
                if (Math.abs(size.height - height) < minDiff) {
                    optimalSize = size;
                    minDiff = Math.abs((double) size.height - height);
                }
            }
            if (optimalSize == null) {
            ...
            Log.d("最佳尺寸:",optimalSize.width + "*" + optimalSize.height);
