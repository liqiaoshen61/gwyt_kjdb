...
class GeoAdapter(listener: ActionListener) : BaseNodeAdapter() {
    ...
    init {
        addFullSpanNodeProvider(GeoLevel1(GeoCollectionModel.LEVEL1, R.layout.item_marker_folder2, listener))
        addNodeProvider(GeoLevel2(GeoCollectionModel.LEVEL2, R.layout.item_marker_collect2, listener))
    }
